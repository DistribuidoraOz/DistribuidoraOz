    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          Nuestra filosofía de empresa es que vos tengas una experiencia gratificante y dinámica, por eso contamos con un staff de personas dedicadas y 
          entusiastas para mejorar cada día y cumplir con cada una de las demandas en tiempo y forma.
          </p>
        </div>
