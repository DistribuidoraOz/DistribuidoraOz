      ...
      {newList.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              "flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-orange-300 p-3 text-sm font-medium hover:bg-stone-100 hover:text-orange-600 md:flex-none md:justify-start md:p-2 md:px-3",
              {
